...
function SideBar() {
  ...
  return (
    <div className='main '>
      ...
      <nav className="navbar p-5  flex-column navbar-expand-lg bg-body-tertiary1 partnav">
        ...
        <div className=' flex-row user'>
          <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="#0074d9" class="bi bi-telephone-fill" viewBox="0 0 16 16">
