...
function Products() {
  ...
  const getProducts =async()=>{
    ...
    const {data}=await axios.get(`${import.meta.env.VITE_API_URL}/products?page=1&limit=1000`,
...
<tfoot>
   ...
   < div className='goToAddUser goto'>
       ...
       <Link to='/dashboard/AddProducts'>    <button className='linkAdd' >Add Product</button> </Link>
