        ...
        <div className='container pagesignin1'>
          ...
          <div className="sign">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <button type='submit' className='btn btn-outline-success' disabled={loader ? 'disabled' : ''}>{!loader ? 'Add Category' : 'wait..'}</button>
            </form>
          </div>
          <div className="sign-part1">

            <img className='userLogo' src="src/pages/AddCategory/img/medicin.jpg" />
